...
import CppModelsViews_Section3
...
Window {
    ...
    ContactsTableModel {
        ...
        onColumnRemoved: {
            contactsHHeaderData.remove(contactsHHeaderData.count-1)
        }
    }
        ...
        TableView {
            ...
            Keys.onDigit1Pressed: {
                if (currentRow >= 0) {
                    ...
                    root.setFullRow(contactsView.model, "Greg", "Doe", "100", "123-456-7890")
            ...
            Keys.onDigit4Pressed: {
                if (currentRow >= 0) {
                    root.setFullRow(contactsView.model, "Sam", "Smith", "50", "098-765-4321")
                }
            }
